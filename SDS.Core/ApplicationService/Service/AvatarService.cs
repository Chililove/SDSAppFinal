...
namespace SDS.Core.ApplicationService.Service
{
    public class AvatarService : IAvatarService
    {
        ...
        public Avatar AvatarCreate(string AvatarType, string name, DateTime birthday, DateTime soldDate, string color, string previousOwner, double price)
        {
